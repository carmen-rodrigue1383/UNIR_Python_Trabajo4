...
Para analizar un conjunto de datos de ventas minoristas.
...
*   Utilizar el dataset [superstore\_dataset2012.csv](https://certidevs-campus.s3.amazonaws.com/file_uploader/1745432818824-superstore_dataset2012.csv) proporcionado

## Instrucciones

**Configura tu entorno de trabajo**  
Crea un nuevo archivo Python (.py) o un notebook Jupyter (.ipynb). Importa las bibliotecas necesarias (pandas, matplotlib, seaborn) y carga el dataset [superstore\_dataset2012.csv](https://certidevs-campus.s3.amazonaws.com/file_uploader/1745432818824-superstore_dataset2012.csv) que ya está disponible en tu entorno.
